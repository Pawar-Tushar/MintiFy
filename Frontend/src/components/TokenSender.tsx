...
//                  }`}
//              >
//                 {isLoading ? ( <div className="flex justify-center items-center"> <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" /* ... */ ></svg> Sending... </div>) : 'Send Tokens'}
//              </button>
...
//                      <div className="mt-1">
//                          <SolanaExplorerLink type="tx" value={lastTxSig} network={connection.rpcEndpoint.includes('devnet') ? 'devnet' : connection.rpcEndpoint.includes('testnet') ? 'testnet' : 'mainnet-beta'}/>
//                      </div>
//                  </div>
//             )}
//         </div>
