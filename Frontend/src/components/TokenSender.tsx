...
const TokenSender: React.FC = () => {
    ...
    return (
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-800">3. Send Tokens</h3>
        ...
        <div className="mb-4">
            <label htmlFor="send_mintAddress" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div className="mb-4">
            <label htmlFor="send_amount" className="block text-sm font-medium text-gray-700 mb-1">
                Amount to Send:
            </label>
            <input
                id="send_amount"
        ...
        {lastTxSig && (
            <div className="mt-4 p-3 bg-green-50 rounded border border-green-200">
                <p className="text-sm font-medium text-green-800">Send Successful! Transaction:</p>
                <div className="mt-1">
                    <SolanaExplorerLink
                        type="tx"
                        value={lastTxSig}
