...
//     Transaction,
//     PublicKey,
//     // Connection, // Uncomment if you need to use Connection directly
//     LAMPORTS_PER_SOL,
// } from '@solana/web3.js';
// import {
//     MINT_SIZE,
...
//                  } else if (error.logs) { 
//                      errorMessage += ` Details: ${JSON.stringify(error.logs)}`;
...
//              <h3 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">1. Create New SPL Token</h3>
...
//                          </p>
//                          <code className="block break-all bg-gray-100 dark:bg-gray-700 p-2 rounded text-xs text-gray-800 dark:text-gray-200 shadow-sm font-mono">
//                              {lastMintAddress}
//                          </code>
//                      </div>
